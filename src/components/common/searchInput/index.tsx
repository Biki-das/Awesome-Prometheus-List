  ...
  return (
    <div className="relative mx-auto">
      <input
        ...
        className="placeholder-xl-light placeholder:text-[12px] placeholder:font-medium border border-base-white py-[7px] px-7 rounded-[4px] mt-[20px] block w-full focus:border-blue-500 focus:outline-none"
      />
      <SearchIcon className="absolute top-0 bottom-0 m-auto left-3" />
